...
'''Richardson Lucy algorithm as implemented by tmodrzyk on github'''
'''https://github.com/Tmodrzyk/richardson-lucy-python/blob/main/src/algorithms/richardson_lucy.py'''
